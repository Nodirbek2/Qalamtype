...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <>
      <header className="w-full max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-6 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 border-b border-[rgba(232,226,216,0.06)] select-none">
        {/* Top Bar for Mobile (< md) OR Left Section for Desktop (>= md) */}
        <div className="w-full md:w-auto flex items-center justify-between md:justify-start gap-3 sm:gap-6">
          {/* Logo */}
          ...
          {/* Mobile Top Right Actions (< md) */}
          <div className="flex md:hidden items-center gap-2 text-[#9A9488] shrink-0">
            {/* Settings Gear Button */}
            <button
              type="button"
              onClick={onOpenSettings}
              className="p-1.5 rounded-lg bg-[#1A1917] hover:bg-[#1A1917]/80 border border-[rgba(232,226,216,0.1)] text-[#9A9488] hover:text-[#E85D3D] transition-colors cursor-pointer flex items-center justify-center"
            ...
            {currentUser && userProfile ? (
              /* Logged in User Profile Dropdown for Mobile */
              <div className="relative" ref={dropdownRef}>
                <div className="flex items-center space-x-1">
                  <button
                    type="button"
                    onClick={() => onNavigate && onNavigate('account')}
                    className={`flex items-center space-x-1.5 bg-[#1A1917] hover:bg-[#1A1917]/80 border rounded-lg px-2.5 py-1 transition-colors cursor-pointer ${
                      activeView === 'account'
                  ...
                  >
                    {userProfile.photoURL ? (
                      ...
                      <div className="w-4 h-4 rounded-full bg-[#E85D3D] text-[#0F0E0D] flex items-center justify-center font-mono font-bold text-[9px]">
                        {userProfile.username.charAt(0).toUpperCase()}
                      </div>
                    )}
                    <span className="font-mono text-xs text-[#E8E2D8] max-w-[70px] truncate">
                  ...
                  <button
                    ...
                    className="bg-[#1A1917] border border-[rgba(232,226,216,0.1)] rounded-lg p-1 text-[#9A9488] transition-colors cursor-pointer"
                  >
              ...
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-[#E85D3D] hover:bg-[#E85D3D]/90 text-[#0F0E0D] font-mono text-xs font-semibold transition-colors flex items-center space-x-1.5 cursor-pointer shadow-sm shrink-0"
              >
        ...
        <div className="flex-1 flex justify-center w-full md:w-auto max-w-full">
          {activeView === 'test' && children}
        </div>

        {/* Desktop Top Right Actions (>= md) */}
        <div className="hidden md:flex items-center gap-2 sm:gap-3 text-[#9A9488] shrink-0">
          {/* Settings Gear Button */}
          <button
            type="button"
            onClick={onOpenSettings}
